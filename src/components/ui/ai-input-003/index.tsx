  ...
  return (
    <div className="relative w-full">
      ...
      <motion.div
        ...
        className="group relative flex items-center overflow-hidden rounded-2xl border bg-[#1a1a1a] px-4 py-2.5 transition-colors duration-300"
      >
        {isSending && (
          <motion.div
            initial={{ y: '220%' }}
        ...
        <Search size={18} className="z-10 text-[#4CC9F0] mr-3" />
        ...
        <input
          ...
          className="z-10 flex-1 border-none bg-transparent py-2 text-[18px] font-semibold text-neutral-100 placeholder-neutral-500 outline-none"
          disabled={disabled}
        />
        ...
        <motion.button
          ...
          className={`z-10 ml-3 flex min-w-[118px] h-11 items-center justify-center rounded-xl px-4 transition-all duration-300 ${
